...
def main():
    ...
    """
    # Pick any integer
    # Do the same with all until addition operator
    ...
    # Additional chords can be added at any time
    # Andrew helped me with Error elimination
    ...
    # List appears in the program not just in the code
    ...
    print("\n")
    while List != 0:
        print('A', 'C', 'G', 'E', 'D', 'F', 'Am', 'Dm', 'Em', 'Am7', 'Bm7', 'Cm7', 'Dm7', 'Em7', 'Fm7', 'A_barr',
              'Bm_barr',
              sep=', ')
