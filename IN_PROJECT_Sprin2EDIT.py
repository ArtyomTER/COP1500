...
chords = {"C": "x32010", "A": "x02220", "G": "320033", "E":
    "022100", "D": "xx0232", "F": "x3321x",
    ...
    for fret_Num in range(1, 10):  # YOU CAN SET THE RANGE TO AS MANY FRETS AS NEEDED
        ...
        for string in fret_Note:
            if string == str(fret_Num):
                fret = fret + "O"  # "O" REFFERS TO FINGER PLACEMENT
            else:
                fret = fret + "|"  # "|" REFFERS TO STRINGS ON THE GUITAR
        print(fret)
...
while List != 0:
    ...
    if List not in chordList:
        print("Incorrect chord enterred, terminating program")
        quit()
